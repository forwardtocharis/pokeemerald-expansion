...
static void TextSpeed_DrawChoices(u8 selection)
{
    ...
    DrawOptionMenuChoice(gText_TextSpeedMid, 120, YPOS_TEXTSPEED, styles[1]);
    DrawOptionMenuChoice(gText_TextSpeedFast, 145, YPOS_TEXTSPEED, styles[2]);
    DrawOptionMenuChoice(gText_TextSpeedInstant, GetStringRightAlignXOffset(FONT_NORMAL, gText_TextSpeedInstant, 204), YPOS_TEXTSPEED, styles[3]);
}
