...
#define VAR_LAST_REPEL_LURE_USED    VAR_UNUSED_0x404E       // If this var has been assigned, the last Repel/Lure used will be saved and the player will be prompted with the vanilla repel YES/NO option, unless I_REPEL_LURE_MENU is set to TRUE.
