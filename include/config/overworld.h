...
#define OW_HM_LEARNABLE_FIELD_MOVE      TRUE       // If TRUE, Pokémon capable of learning an HM can use its out-of-battle move if the player owns the HM in their bag and has the required badge.
